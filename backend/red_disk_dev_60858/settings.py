"""
Django settings for red_disk_dev_60858 project.
...
ROOT_URLCONF = 'red_disk_dev_60858.urls'
...
WSGI_APPLICATION = 'red_disk_dev_60858.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_disk_dev_60858 API",
    "DESCRIPTION": "API documentation for red_disk_dev_60858 App",
    "VERSION": "v1",
}
